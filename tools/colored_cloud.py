...
#: Default forward-projection tunables (CLI flags, not calibration-ledger entries).
DEFAULT_MIN_RANGE = 0.75  # m — kills the near-field parallax miscoloring tail
DEFAULT_VOXEL = 0.05  # m
_NEAR_ZERO_RANGE = 1e-6  # m — degenerate apex-coincident points
...
def project_points_to_pano(
    ...
    *,
    ...
    invalid and never clamped. Points closer than ``min_range`` (or within
    numerical zero of the apex) are also invalid.
    """
