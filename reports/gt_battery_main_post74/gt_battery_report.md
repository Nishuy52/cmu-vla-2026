...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.511 (mean ordered-leg credit 0.572; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.087 m, coverage-1m 52% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| home_building_2 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=67 | diag: Frechet=12.60m cover1m=12% | 1 corridor leg(s) never threaded; leg 0: threading: trajectory never crossed the gate segment | Take the path between the sofa and the coffee table ... |
...
| livingroom_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=83 | diag: Frechet=4.76m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
...
| office_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=27 | diag: Frechet=5.23m cover1m=43% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=7 | diag: Frechet=3.47m cover1m=15% |  | Go to the vases on the cabinet below the TV and stop... |
