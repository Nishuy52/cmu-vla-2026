...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.167 (mean ordered-leg credit 0.189; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.284 m, coverage-1m 47% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| livingroom_4 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=8 | diag: Frechet=2.24m cover1m=50% |  | Go near the chair closest to the bookcase and stop a... |
...
| loft | inst | rubric=0.00 legs=0/3 thread_viol=0 avoid_viol=0 poses=5 | diag: Frechet=7.26m cover1m=27% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_1 | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=7854 | diag: Frechet=0.78m cover1m=100% |  | First, go near the potted plant on the shelf, then t... |
...
| office_2 | inst | rubric=0.00 legs=0/3 thread_viol=0 avoid_viol=0 poses=33 | diag: Frechet=5.23m cover1m=43% |  | First, go to the trash can near the cabinet, then go... |
