...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.150 (mean ordered-leg credit 0.161; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.164 m, coverage-1m 49% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=23 | diag: Frechet=6.26m cover1m=27% |  | Go near the potted plant on the table and stop at th... |
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=40 | diag: Frechet=7.04m cover1m=88% |  | Go to the coffee table with the kettle on it and sto... |
| home_building_1 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=9 | diag: Frechet=11.45m cover1m=6% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the nightstand with a clock on it, then... |
