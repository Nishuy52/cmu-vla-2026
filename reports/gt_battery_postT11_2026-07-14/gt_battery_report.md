...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.100 (mean ordered-leg credit 0.122; 8 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.542 m, coverage-1m 41% over 24 aligned; 3 scene(s) unaligned: chinese_room, home_building_2, livingroom_3.
...
| chinese_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=6.26m cover1m=27% |  | Go near the potted plant on the table and stop at th... |
...
| hotel_room_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=1.28m cover1m=93% |  | Go to the bedside table closest to the window and st... |
| hotel_room_1 | inst | rubric=0.00 legs=0/3 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=1.61m cover1m=75% |  | First, go near the bedside table closest to the benc... |
...
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=2.82m cover1m=60% |  | Go to the microwave on the kitchen counter and then ... |
| livingroom_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=4.47m cover1m=31% |  | First, go to the chair near the window, then stop at... |
...
| livingroom_3 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=6.24m cover1m=30% |  | Take the path near the TV and go to the pillow farth... |
...
| livingroom_4 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=1.77m cover1m=70% |  | Go near the chair closest to the bookcase and stop a... |
...
| office_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=2.40m cover1m=46% |  | Go near the potted plant on the cabinet and stop at ... |
...
| studio | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4001 | diag: Frechet=3.47m cover1m=14% |  | Go to the vases on the cabinet below the TV and stop... |
