# GT battery — REAL accuracy report (2026-07-20)
...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.539 (mean ordered-leg credit 0.600; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 3.878 m, coverage-1m 55% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| arabic_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=49 | diag: Frechet=3.30m cover1m=39% |  | Go near the stool under the picture and stop at the ... |
| arabic_room | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=10 | diag: Frechet=3.46m cover1m=32% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the potted plant furthest from the hook... |
...
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=78 | diag: Frechet=3.76m cover1m=52% |  | Go near the potted plant on the table and stop at th... |
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=28 | diag: Frechet=4.27m cover1m=64% |  | First, go near the tea table with the elephant figur... |
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=180 | diag: Frechet=12.91m cover1m=8% | interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
| home_building_1 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=53 | diag: Frechet=9.77m cover1m=11% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment; interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the nightstand with a clock on it, then... |
...
| home_building_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=73 | diag: Frechet=3.24m cover1m=36% |  | Go near the magazine on the ottoman, then go to the ... |
| home_building_2 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=10 | diag: Frechet=11.29m cover1m=4% | 1 corridor leg(s) never threaded; leg 0: threading: trajectory never crossed the gate segment | Take the path between the sofa and the coffee table ... |
...
| hotel_room_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=11 | diag: Frechet=3.17m cover1m=39% |  | Go to the bedside table closest to the window and st... |
| hotel_room_1 | inst | rubric=0.33 legs=2/3 thread_viol=1 avoid_viol=0 poses=19 | diag: Frechet=1.90m cover1m=80% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the bedside table closest to the benc... |
...
| japanese_room | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=19 | diag: Frechet=0.53m cover1m=100% |  | Go near the small table with a vase on it and then t... |
| japanese_room | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=30 | diag: Frechet=1.18m cover1m=91% |  | Go to the lantern closest to the fan decoration, the... |
...
| livingroom_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=125 | diag: Frechet=4.93m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
...
| livingroom_2 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=45 | diag: Frechet=1.03m cover1m=98% |  | Go to the microwave on the kitchen counter and then ... |
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=36 | diag: Frechet=4.79m cover1m=42% |  | First, go to the chair near the window, then stop at... |
...
| livingroom_4 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=24 | diag: Frechet=0.88m cover1m=100% |  | Go near the chair closest to the bookcase and stop a... |
| livingroom_4 | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=24 | diag: Frechet=3.30m cover1m=32% |  | First, go near the fireplace, then go to the window ... |
...
| loft | inst | rubric=0.00 legs=0/1 thread_viol=0 avoid_viol=0 poses=3 | diag: Frechet=7.85m cover1m=9% |  | Go to the cup near the TV remote and avoid the path ... |
| loft | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=12 | diag: Frechet=7.26m cover1m=36% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=34 | diag: Frechet=4.64m cover1m=51% |  | Go to the potted plant furthest from the projector s... |
| office_1 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=22 | diag: Frechet=0.78m cover1m=100% |  | First, go near the potted plant on the shelf, then t... |
...
| office_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=54 | diag: Frechet=1.88m cover1m=98% |  | Go near the potted plant on the cabinet and stop at ... |
| office_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=70 | diag: Frechet=1.71m cover1m=91% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=12 | diag: Frechet=3.47m cover1m=17% |  | Go to the vases on the cabinet below the TV and stop... |
| studio | inst | rubric=0.33 legs=2/3 thread_viol=1 avoid_viol=0 poses=27 | diag: Frechet=3.65m cover1m=12% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the vase closest to the easel, then, ta... |
