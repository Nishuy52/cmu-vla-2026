...
- **Numerical** (n=15): TRUE accuracy 13/15 (answer key: questions.pdf); independent (referential) agreement 56% over 9 with strict evidence; scene-graph agreement 64% over 11; 3 question(s) had no independent evidence (class-only counts excluded from agreement).
...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.117 (mean ordered-leg credit 0.139; 8 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 5.634 m, coverage-1m 38% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=58 | diag: Frechet=6.26m cover1m=27% |  | Go near the potted plant on the table and stop at th... |
| chinese_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=10 | diag: Frechet=6.54m cover1m=29% |  | First, go near the tea table with the elephant figur... |
...
| home_building_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=40 | diag: Frechet=20.98m cover1m=7% |  | Go near the magazine on the ottoman, then go to the ... |
| home_building_2 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=242 | diag: Frechet=18.88m cover1m=4% | 1 corridor leg(s) never threaded; leg 0: threading: trajectory never crossed the gate segment | Take the path between the sofa and the coffee table ... |
...
| livingroom_1 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=31 | diag: Frechet=1.58m cover1m=88% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the lamp closest to the black chair, ... |
