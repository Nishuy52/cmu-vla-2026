...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.100 (mean ordered-leg credit 0.122; 9 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 6.047 m, coverage-1m 37% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=59 | diag: Frechet=10.92m cover1m=49% |  | Go to the coffee table with the kettle on it and sto... |
| home_building_1 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=48 | diag: Frechet=18.17m cover1m=3% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the nightstand with a clock on it, then... |
...
| hotel_room_2 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=16 | diag: Frechet=2.90m cover1m=60% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the picture closest to the door, then t... |
...
| livingroom_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=10 | diag: Frechet=4.46m cover1m=12% |  | Go to the potted plant closest to the pyramid candle... |
| livingroom_1 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=5 | diag: Frechet=6.49m cover1m=32% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the lamp closest to the black chair, ... |
...
| livingroom_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=4.80m cover1m=36% |  | First, go to the chair near the window, then stop at... |
...
| office_1 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=4002 | diag: Frechet=0.88m cover1m=100% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the potted plant on the shelf, then t... |
