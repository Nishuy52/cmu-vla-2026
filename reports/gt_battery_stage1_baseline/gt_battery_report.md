...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.611 (mean ordered-leg credit 0.633; 3 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 3.593 m, coverage-1m 58% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| arabic_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=44 | diag: Frechet=3.30m cover1m=39% |  | Go near the stool under the picture and stop at the ... |
...
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=80 | diag: Frechet=3.60m cover1m=52% |  | Go near the potted plant on the table and stop at th... |
...
| home_building_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=66 | diag: Frechet=3.24m cover1m=36% |  | Go near the magazine on the ottoman, then go to the ... |
| home_building_2 | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=124 | diag: Frechet=3.07m cover1m=49% |  | Take the path between the sofa and the coffee table ... |
...
| hotel_room_1 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=31 | diag: Frechet=1.33m cover1m=91% |  | First, go near the bedside table closest to the benc... |
...
| japanese_room | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=25 | diag: Frechet=0.53m cover1m=100% |  | Go near the small table with a vase on it and then t... |
...
| livingroom_2 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=46 | diag: Frechet=1.03m cover1m=98% |  | Go to the microwave on the kitchen counter and then ... |
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=37 | diag: Frechet=4.79m cover1m=41% |  | First, go to the chair near the window, then stop at... |
...
| livingroom_4 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=26 | diag: Frechet=0.88m cover1m=100% |  | Go near the chair closest to the bookcase and stop a... |
| livingroom_4 | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=25 | diag: Frechet=3.14m cover1m=34% |  | First, go near the fireplace, then go to the window ... |
...
| loft | inst | rubric=0.00 legs=0/1 thread_viol=0 avoid_viol=0 poses=8 | diag: Frechet=7.00m cover1m=13% |  | Go to the cup near the TV remote and avoid the path ... |
| loft | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=16 | diag: Frechet=6.06m cover1m=41% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=36 | diag: Frechet=4.64m cover1m=51% |  | Go to the potted plant furthest from the projector s... |
...
| office_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=53 | diag: Frechet=1.88m cover1m=99% |  | Go near the potted plant on the cabinet and stop at ... |
| office_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=70 | diag: Frechet=1.66m cover1m=92% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=35 | diag: Frechet=2.46m cover1m=28% |  | First, go to the vase closest to the easel, then, ta... |
