...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.406 (mean ordered-leg credit 0.467; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.193 m, coverage-1m 48% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=58 | diag: Frechet=4.64m cover1m=50% |  | Go near the potted plant on the table and stop at th... |
| chinese_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4040 | diag: Frechet=4.27m cover1m=64% |  | First, go near the tea table with the elephant figur... |
...
| home_building_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=4202 | diag: Frechet=11.44m cover1m=8% | interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
| home_building_1 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=48 | diag: Frechet=9.77m cover1m=11% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment; interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the nightstand with a clock on it, then... |
...
| home_building_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=69 | diag: Frechet=3.24m cover1m=36% |  | Go near the magazine on the ottoman, then go to the ... |
| home_building_2 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=62 | diag: Frechet=12.60m cover1m=12% | 1 corridor leg(s) never threaded; leg 0: threading: trajectory never crossed the gate segment | Take the path between the sofa and the coffee table ... |
...
| hotel_room_2 | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=21 | diag: Frechet=2.90m cover1m=60% | interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the picture closest to the door, then t... |
...
| japanese_room | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=22 | diag: Frechet=0.94m cover1m=100% |  | Go near the small table with a vase on it and then t... |
| japanese_room | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=42 | diag: Frechet=1.02m cover1m=99% |  | Go to the lantern closest to the fan decoration, the... |
...
| livingroom_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=66 | diag: Frechet=4.68m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
...
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=19 | diag: Frechet=4.79m cover1m=44% |  | First, go to the chair near the window, then stop at... |
...
| livingroom_4 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=8 | diag: Frechet=2.24m cover1m=50% |  | Go near the chair closest to the bookcase and stop a... |
...
| loft | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=5 | diag: Frechet=7.26m cover1m=27% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_1 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=7850 | diag: Frechet=0.78m cover1m=100% |  | First, go near the potted plant on the shelf, then t... |
...
| office_2 | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=33 | diag: Frechet=5.23m cover1m=43% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=6 | diag: Frechet=3.47m cover1m=14% |  | Go to the vases on the cabinet below the TV and stop... |
| studio | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=15 | diag: Frechet=3.65m cover1m=12% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the vase closest to the easel, then, ta... |
