...
- **Instruction following** (n=2): mean discrete Frechet 10.312 m; mean coverage within 1.0 m 0%.
...
| loft | obje | IoU=n/a tgt=None(none) | no GT target matched; IoU undefined (flagged, not guessed) | Find the potted plant between a vase and the cabinet... |
| loft | inst | Frechet=11.16m cover1m=0% (ours 44/gt 739) |  | Go to the cup near the TV remote and avoid the path ... |
| loft | inst | Frechet=9.46m cover1m=0% (ours 45/gt 771) |  | Go near the fireplace, pass by the stairs, then stop... |
