...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.117 (mean ordered-leg credit 0.139; 9 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 5.887 m, coverage-1m 37% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=185 | diag: Frechet=16.22m cover1m=8% | interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
| home_building_1 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=30 | diag: Frechet=13.07m cover1m=3% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment; interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the nightstand with a clock on it, then... |
...
| hotel_room_2 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=17 | diag: Frechet=2.90m cover1m=60% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment; interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the picture closest to the door, then t... |
