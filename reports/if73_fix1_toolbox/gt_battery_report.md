...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.433 (mean ordered-leg credit 0.494; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.193 m, coverage-1m 48% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4202 | diag: Frechet=11.44m cover1m=8% | interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
...
| livingroom_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=66 | diag: Frechet=4.68m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
...
| office_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=33 | diag: Frechet=5.23m cover1m=43% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=6 | diag: Frechet=3.47m cover1m=14% |  | Go to the vases on the cabinet below the TV and stop... |
