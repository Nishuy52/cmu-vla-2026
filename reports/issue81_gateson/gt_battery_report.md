# GT battery — REAL accuracy report (2026-07-26)
...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.622 (mean ordered-leg credit 0.656; 5 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 2.966 m, coverage-1m 62% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| arabic_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=0 | diag: Frechet=n/a cover1m=0% | driven trajectory empty — pipeline produced no motion | Go near the stool under the picture and stop at the ... |
| arabic_room | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=0 | diag: Frechet=n/a cover1m=0% | driven trajectory empty — pipeline produced no motion; 1 corridor leg(s) never threaded; leg 1: threading: trajectory needs >=2 (x,y) points | First, go to the potted plant furthest from the hook... |
...
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=11 | diag: Frechet=6.29m cover1m=29% |  | First, go near the tea table with the elephant figur... |
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=0 | diag: Frechet=n/a cover1m=0% | driven trajectory empty — pipeline produced no motion; interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
...
| hotel_room_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=0 | diag: Frechet=n/a cover1m=0% | driven trajectory empty — pipeline produced no motion | Go to the bedside table closest to the window and st... |
| hotel_room_1 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=0 | diag: Frechet=n/a cover1m=0% | driven trajectory empty — pipeline produced no motion; 1 corridor leg(s) never threaded; leg 1: threading: trajectory needs >=2 (x,y) points | First, go near the bedside table closest to the benc... |
...
| livingroom_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=76 | diag: Frechet=6.96m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
...
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=17 | diag: Frechet=10.16m cover1m=36% |  | First, go to the chair near the window, then stop at... |
...
| loft | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=8 | diag: Frechet=8.52m cover1m=36% |  | Go near the fireplace, pass by the stairs, then stop... |
