...
| hotel_room_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=40 | diag: Frechet=1.45m cover1m=89% | interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the picture closest to the door, then t... |
...
| office_1 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=23 | diag: Frechet=0.78m cover1m=100% |  | First, go near the potted plant on the shelf, then t... |
