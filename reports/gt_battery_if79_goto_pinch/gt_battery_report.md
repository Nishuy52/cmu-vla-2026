...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.589 (mean ordered-leg credit 0.611; 3 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 3.592 m, coverage-1m 56% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| hotel_room_1 | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=28 | diag: Frechet=1.90m cover1m=82% |  | First, go near the bedside table closest to the benc... |
...
| hotel_room_2 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=18 | diag: Frechet=0.82m cover1m=100% | interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | Go between the bench and the bed and stop at the lam... |
...
| studio | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=35 | diag: Frechet=3.65m cover1m=12% |  | First, go to the vase closest to the easel, then, ta... |
