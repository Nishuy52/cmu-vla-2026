...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.461 (mean ordered-leg credit 0.522; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.176 m, coverage-1m 50% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| arabic_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=18 | diag: Frechet=3.30m cover1m=39% |  | Go near the stool under the picture and stop at the ... |
...
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=53 | diag: Frechet=4.64m cover1m=51% |  | Go near the potted plant on the table and stop at th... |
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=167 | diag: Frechet=12.41m cover1m=8% | interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
...
| hotel_room_1 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=10 | diag: Frechet=2.58m cover1m=47% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the bedside table closest to the benc... |
...
| hotel_room_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=37 | diag: Frechet=2.01m cover1m=78% | interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the picture closest to the door, then t... |
...
| livingroom_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=79 | diag: Frechet=4.76m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
...
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=18 | diag: Frechet=2.62m cover1m=64% |  | Go to the microwave on the kitchen counter and then ... |
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=21 | diag: Frechet=4.79m cover1m=43% |  | First, go to the chair near the window, then stop at... |
...
| livingroom_4 | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=25 | diag: Frechet=3.30m cover1m=32% |  | First, go near the fireplace, then go to the window ... |
...
| office_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=39 | diag: Frechet=1.15m cover1m=98% |  | Go near the potted plant on the cabinet and stop at ... |
| office_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=28 | diag: Frechet=5.23m cover1m=43% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=0.33 legs=2/3 thread_viol=1 avoid_viol=0 poses=14 | diag: Frechet=3.65m cover1m=12% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the vase closest to the easel, then, ta... |
