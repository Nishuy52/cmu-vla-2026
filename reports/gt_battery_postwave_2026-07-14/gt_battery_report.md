# GT battery — REAL accuracy report (2026-07-14)
...
- **Numerical** (n=15): pipeline exact-match 100%; independent (referential) agreement 56% over 9 with strict evidence; scene-graph agreement 73% over 11; 3 question(s) had no independent evidence (class-only counts excluded from agreement).
- **Object reference** (n=30, scored=8): mean 3D IoU 0.875; IoU>=0.25 88%; IoU>=0.5 88%. Match method: none=22, relation=7, unique=1.
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.061 (mean ordered-leg credit 0.094; 9 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 5.006 m, coverage-1m 33% over 24 aligned; 3 scene(s) unaligned: chinese_room, home_building_2, livingroom_3.
...
| arabic_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=3.30m cover1m=26% |  | Go near the stool under the picture and stop at the ... |
| arabic_room | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=2 | diag: Frechet=3.46m cover1m=37% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the potted plant furthest from the hook... |
...
| chinese_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=12 | diag: Frechet=6.26m cover1m=25% |  | Go near the potted plant on the table and stop at th... |
...
| hotel_room_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=14 | diag: Frechet=4.38m cover1m=12% |  | Go to the bedside table closest to the window and st... |
| hotel_room_1 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=18 | diag: Frechet=2.83m cover1m=20% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the bedside table closest to the benc... |
...
| hotel_room_2 | inst | rubric=0.00 legs=0/2 thread_viol=1 avoid_viol=0 poses=64 | diag: Frechet=5.12m cover1m=59% | 1 corridor leg(s) never threaded; leg 0: threading: trajectory never crossed the gate segment | Go between the bench and the bed and stop at the lam... |
| hotel_room_2 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=30 | diag: Frechet=2.58m cover1m=33% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the picture closest to the door, then t... |
...
| livingroom_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=69 | diag: Frechet=10.02m cover1m=12% |  | Go to the potted plant closest to the pyramid candle... |
...
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=7 | diag: Frechet=3.45m cover1m=45% |  | Go to the microwave on the kitchen counter and then ... |
| livingroom_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=9 | diag: Frechet=4.47m cover1m=34% |  | First, go to the chair near the window, then stop at... |
...
| livingroom_3 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=6 | diag: Frechet=4.48m cover1m=30% |  | Take the path near the TV and go to the pillow farth... |
| livingroom_3 | inst | rubric=0.00 legs=0/3 thread_viol=0 avoid_viol=0 poses=70 | diag: Frechet=5.08m cover1m=19% |  | First, go near the stool, then take the path near th... |
...
| livingroom_4 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=102 | diag: Frechet=4.95m cover1m=17% |  | Go near the chair closest to the bookcase and stop a... |
| livingroom_4 | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=79 | diag: Frechet=4.34m cover1m=36% |  | First, go near the fireplace, then go to the window ... |
...
| loft | inst | rubric=0.00 legs=0/1 thread_viol=0 avoid_viol=0 poses=82 | diag: Frechet=4.86m cover1m=9% |  | Go to the cup near the TV remote and avoid the path ... |
| loft | inst | rubric=0.00 legs=0/3 thread_viol=0 avoid_viol=0 poses=82 | diag: Frechet=4.13m cover1m=36% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=4.19m cover1m=24% |  | Go to the potted plant furthest from the projector s... |
...
| office_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=22 | diag: Frechet=1.25m cover1m=97% |  | Go near the potted plant on the cabinet and stop at ... |
| office_2 | inst | rubric=0.00 legs=0/3 thread_viol=0 avoid_viol=0 poses=23 | diag: Frechet=2.91m cover1m=53% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=0.00 legs=0/1 thread_viol=0 avoid_viol=0 poses=0 | diag: Frechet=n/a cover1m=0% | driven trajectory empty — pipeline produced no motion | Go to the vases on the cabinet below the TV and stop... |
| studio | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=60 | diag: Frechet=2.45m cover1m=64% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the vase closest to the easel, then, ta... |
