# GT battery — REAL accuracy report (2026-07-18)
...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.117 (mean ordered-leg credit 0.139; 8 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 5.416 m, coverage-1m 40% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| home_building_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=242 | diag: Frechet=17.14m cover1m=7% |  | Go near the magazine on the ottoman, then go to the ... |
