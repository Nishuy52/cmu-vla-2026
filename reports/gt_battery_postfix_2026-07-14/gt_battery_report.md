...
| livingroom_4 | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=79 | diag: Frechet=4.34m cover1m=35% |  | First, go near the fireplace, then go to the window ... |
