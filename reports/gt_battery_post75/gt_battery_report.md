...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.417 (mean ordered-leg credit 0.478; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.051 m, coverage-1m 50% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| livingroom_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=30 | diag: Frechet=4.46m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
...
| office_2 | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=47 | diag: Frechet=3.33m cover1m=68% |  | First, go to the trash can near the cabinet, then go... |
