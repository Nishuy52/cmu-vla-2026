...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.172 (mean ordered-leg credit 0.194; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.284 m, coverage-1m 47% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| livingroom_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=66 | diag: Frechet=4.68m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
