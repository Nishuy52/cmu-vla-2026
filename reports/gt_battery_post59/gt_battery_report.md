...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.150 (mean ordered-leg credit 0.172; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.283 m, coverage-1m 47% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| arabic_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=56 | diag: Frechet=3.30m cover1m=39% |  | Go near the stool under the picture and stop at the ... |
...
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=92 | diag: Frechet=4.64m cover1m=52% |  | Go near the potted plant on the table and stop at th... |
...
| home_building_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=69 | diag: Frechet=3.24m cover1m=36% |  | Go near the magazine on the ottoman, then go to the ... |
...
| hotel_room_1 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=51 | diag: Frechet=2.58m cover1m=47% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the bedside table closest to the benc... |
...
| japanese_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4016 | diag: Frechet=0.94m cover1m=100% |  | Go near the small table with a vase on it and then t... |
| japanese_room | inst | rubric=0.00 legs=0/3 thread_viol=0 avoid_viol=0 poses=73 | diag: Frechet=1.21m cover1m=92% |  | Go to the lantern closest to the fan decoration, the... |
...
| livingroom_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=4037 | diag: Frechet=4.68m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
...
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=57 | diag: Frechet=2.56m cover1m=66% |  | Go to the microwave on the kitchen counter and then ... |
| livingroom_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4028 | diag: Frechet=4.79m cover1m=43% |  | First, go to the chair near the window, then stop at... |
...
| livingroom_4 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4023 | diag: Frechet=2.24m cover1m=51% |  | Go near the chair closest to the bookcase and stop a... |
...
| loft | inst | rubric=0.00 legs=0/3 thread_viol=0 avoid_viol=0 poses=45 | diag: Frechet=7.26m cover1m=27% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=71 | diag: Frechet=1.29m cover1m=89% |  | Go near the potted plant on the cabinet and stop at ... |
