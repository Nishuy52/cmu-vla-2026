...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.611 (mean ordered-leg credit 0.633; 3 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 3.573 m, coverage-1m 57% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| hotel_room_1 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=28 | diag: Frechet=1.33m cover1m=91% |  | First, go near the bedside table closest to the benc... |
...
| hotel_room_2 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=22 | diag: Frechet=2.05m cover1m=100% | interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | Go between the bench and the bed and stop at the lam... |
...
| studio | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=32 | diag: Frechet=2.46m cover1m=27% |  | First, go to the vase closest to the easel, then, ta... |
