...
reports/gt_battery_if77c_fix1_gotopinch/gt_battery_results.json, using the same
...
SRC = Path(__file__).resolve().parents[2] / "reports" / "gt_battery_if77c_fix1_gotopinch" / "gt_battery_results.json"
OUT = Path(__file__).parent / "legs_fix1.json"
