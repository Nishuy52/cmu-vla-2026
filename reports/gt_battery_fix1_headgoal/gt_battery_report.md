...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.706 (mean ordered-leg credit 0.789; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.284 m, coverage-1m 47% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| arabic_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=18 | diag: Frechet=3.30m cover1m=39% |  | Go near the stool under the picture and stop at the ... |
| arabic_room | inst | rubric=0.33 legs=2/3 thread_viol=1 avoid_viol=0 poses=10 | diag: Frechet=3.46m cover1m=32% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the potted plant furthest from the hook... |
...
| chinese_room | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=58 | diag: Frechet=4.64m cover1m=50% |  | Go near the potted plant on the table and stop at th... |
| chinese_room | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=4040 | diag: Frechet=4.27m cover1m=64% |  | First, go near the tea table with the elephant figur... |
...
| home_building_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=98 | diag: Frechet=13.68m cover1m=8% | interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
...
| home_building_2 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=69 | diag: Frechet=3.24m cover1m=36% |  | Go near the magazine on the ottoman, then go to the ... |
| home_building_2 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=62 | diag: Frechet=12.60m cover1m=12% | 1 corridor leg(s) never threaded; leg 0: threading: trajectory never crossed the gate segment | Take the path between the sofa and the coffee table ... |
...
| hotel_room_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=9 | diag: Frechet=3.17m cover1m=39% |  | Go to the bedside table closest to the window and st... |
| hotel_room_1 | inst | rubric=0.67 legs=3/3 thread_viol=1 avoid_viol=0 poses=10 | diag: Frechet=2.58m cover1m=47% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the bedside table closest to the benc... |
...
| hotel_room_2 | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=22 | diag: Frechet=2.90m cover1m=60% | interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the picture closest to the door, then t... |
...
| japanese_room | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=30 | diag: Frechet=1.38m cover1m=84% |  | Go to the lantern closest to the fan decoration, the... |
...
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=20 | diag: Frechet=2.56m cover1m=66% |  | Go to the microwave on the kitchen counter and then ... |
...
| livingroom_4 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=25 | diag: Frechet=3.30m cover1m=32% |  | First, go near the fireplace, then go to the window ... |
...
| loft | inst | rubric=1.00 legs=1/1 thread_viol=0 avoid_viol=0 poses=3 | diag: Frechet=7.85m cover1m=9% |  | Go to the cup near the TV remote and avoid the path ... |
| loft | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=5 | diag: Frechet=7.26m cover1m=27% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=29 | diag: Frechet=4.87m cover1m=48% |  | Go to the potted plant furthest from the projector s... |
...
| studio | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=6 | diag: Frechet=3.47m cover1m=14% |  | Go to the vases on the cabinet below the TV and stop... |
| studio | inst | rubric=0.33 legs=2/3 thread_viol=1 avoid_viol=0 poses=15 | diag: Frechet=3.65m cover1m=12% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the vase closest to the easel, then, ta... |
