...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.200 (mean ordered-leg credit 0.222; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.284 m, coverage-1m 47% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=98 | diag: Frechet=13.68m cover1m=8% | interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
...
| hotel_room_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=9 | diag: Frechet=3.17m cover1m=39% |  | Go to the bedside table closest to the window and st... |
...
| japanese_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=22 | diag: Frechet=0.94m cover1m=100% |  | Go near the small table with a vase on it and then t... |
| japanese_room | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=30 | diag: Frechet=1.38m cover1m=84% |  | Go to the lantern closest to the fan decoration, the... |
...
| livingroom_1 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=46 | diag: Frechet=1.58m cover1m=88% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment; interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go near the lamp closest to the black chair, ... |
...
| livingroom_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=19 | diag: Frechet=4.79m cover1m=44% |  | First, go to the chair near the window, then stop at... |
...
| livingroom_3 | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=4171 | diag: Frechet=3.74m cover1m=100% | frame fit unaligned — DATA-CONFIRMED unfittable (meth-F11): GT q4/q5 terminal endpoints are 1.20 m apart but every pillow x bowl pairing is >= 3.27 m apart — a frame-independent distance contradiction (rigid two-point residual floor 1.04 m > 1.0 m gate). The q4 trajectory ends in the dining-chair corner (1.04 m from a chair, 1.33 m from the nearest pillow), not at any pillow; no rigid sim->object transform can map the endpoints onto the terminal objects.; interior walls unavailable (frame fit residual 1.81 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go near the stool, then take the path near th... |
...
| livingroom_4 | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=25 | diag: Frechet=3.30m cover1m=32% |  | First, go near the fireplace, then go to the window ... |
...
| loft | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=5 | diag: Frechet=7.26m cover1m=27% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_1 | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=7854 | diag: Frechet=0.78m cover1m=100% |  | First, go near the potted plant on the shelf, then t... |
...
| office_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=39 | diag: Frechet=1.15m cover1m=98% |  | Go near the potted plant on the cabinet and stop at ... |
| office_2 | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=33 | diag: Frechet=5.23m cover1m=43% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=15 | diag: Frechet=3.65m cover1m=12% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the vase closest to the easel, then, ta... |
