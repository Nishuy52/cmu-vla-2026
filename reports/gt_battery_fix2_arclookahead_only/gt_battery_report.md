...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.450 (mean ordered-leg credit 0.511; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.175 m, coverage-1m 50% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| hotel_room_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=34 | diag: Frechet=2.01m cover1m=78% | interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the picture closest to the door, then t... |
...
| office_1 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=17 | diag: Frechet=0.78m cover1m=100% |  | First, go near the potted plant on the shelf, then t... |
