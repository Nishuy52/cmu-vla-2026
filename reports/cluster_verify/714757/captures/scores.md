# Live baseline scores (2026-08-08)
...
|---|---|---|---|---|---|---|---|
| arabic_room | nume | 0.0000 | 1.0000 | -1.0000 |  | live=9 true=2 | How many sofas are below a window? |
| chinese_room | nume | 1.0000 | 1.0000 | 0.0000 |  | live=6 true=6 | Count the number of chairs with pillows on them. |
| home_building_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=3 true=6 | How many pillows are on the sofa under the pictures? |
| home_building_2 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=0 true=2 | How many red pillows are on the sofa? |
| hotel_room_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=1 true=4 | How many pillows are on the bed? |
...
| livingroom_3 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=5 true=2 | How many photos are on the TV cabinet? |
| livingroom_4 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=3 true=6 | How many pillows are on a sofa? |
| loft | nume | 1.0000 | 1.0000 | 0.0000 |  | live=2 true=2 | How many black pillows are on the sofa? |
| office_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=5 true=6 | How many computer monitors are on the table closest to the map wall de |
| office_2 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=2 true=1 | How many potted plants are on a table? |
