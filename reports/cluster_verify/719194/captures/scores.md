...
| chinese_room | inst | 0.0000 | 0.5000 | -0.5000 |  | legs=1/1; avoid[0]: trajectory entered capsule at (3.10, 0.89) | First, go near the tea table with the elephant figurine on it, then st |
| chinese_room | inst | 0.0000 | 1.0000 | -1.0000 |  | legs=0/2 | Go near the potted plant on the table and stop at the painting near th |
| home_building_1 | inst | 0.0000 | 0.0000 | 0.0000 |  | legs=1/3; leg 1: threading: trajectory never crossed the gate segment | First, go to the nightstand with a clock on it, then take the path bet |
...
| instruction_following | 10 | 9 | 1 | 0.1667 |
