...
| chinese_room | inst | 0.0000 | 0.5000 | -0.5000 |  | legs=0/1 | First, go near the tea table with the elephant figurine on it, then st |
...
| hotel_room_1 | inst | 0.0000 | 1.0000 | -1.0000 |  | legs=0/1 | Go to the bedside table closest to the window and stop at the chair cl |
...
| instruction_following | 10 | 9 | 1 | 0.0556 |
