...
| arabic_room | obje | n/a | n/a | n/a | keyframes_processed=35 is far below the job's median (87) — capture-completeness issue (#158) | no GT target matched; IoU undefined (flagged, not guessed) | Find the wall lamp that is between a door frame and a window. |
...
|---|---|---|---|---|
| numerical | 0 | 0 | 0 | n/a |
| object_reference | 16 | 12 | 0 | 0.0000 |
