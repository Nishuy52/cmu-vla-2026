...
| hotel_room_1 | obje | 0.3173 | 1.0000 | -0.6827 |  |  | Find the bedside table farthest from the window. |
...
| livingroom_1 | obje | 0.1165 | n/a | n/a |  |  | Find the vase on the cabinet below the picture. |

Runs with a capture-completeness issue: 0/16.
...
|---|---|---|---|---|
| numerical | 0 | 0 | 0 | n/a |
| object_reference | 16 | 12 | 0 | 0.0362 |
