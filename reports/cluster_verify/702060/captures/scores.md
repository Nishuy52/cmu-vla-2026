...
| livingroom_1 | inst | 0.6667 | 0.0000 | 0.6667 |  | legs=3/3; leg 1: threading: trajectory never crossed the gate segment | First, go near the lamp closest to the black chair, then take the path |
| livingroom_1 | inst | 1.0000 | 1.0000 | 0.0000 |  | legs=2/2 | Go to the potted plant closest to the pyramid candle holder and stop a |
| livingroom_2 | inst | 0.5000 | 0.5000 | 0.0000 |  | legs=2/2; avoid[0]: trajectory entered capsule at (1.28, -3.20) | First, go to the chair near the window, then stop at the soccer ball n |
| livingroom_2 | inst | 0.5000 | 1.0000 | -0.5000 |  | legs=1/2 | Go to the microwave on the kitchen counter and then go to the crystal  |
| livingroom_3 | inst | 1.0000 | 0.6667 | 0.3333 |  | legs=3/3 | First, go near the stool, then take the path near the cabinet, and sto |
| livingroom_3 | inst | 0.5000 | 0.5000 | 0.0000 |  | legs=1/2 | Take the path near the TV and go to the pillow farthest from the lamp. |
