...
|---|---|---|---|---|---|---|---|
| arabic_room | nume | 0.0000 | 1.0000 | -1.0000 |  | live=8 true=2 | How many sofas are below a window? |
| chinese_room | nume | 0.0000 | 1.0000 | -1.0000 |  | live=8 true=6 | Count the number of chairs with pillows on them. |
| home_building_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=4 true=6 | How many pillows are on the sofa under the pictures? |
| home_building_2 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=0 true=2 | How many red pillows are on the sofa? |
| hotel_room_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=8 true=4 | How many pillows are on the bed? |
| hotel_room_2 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=5 true=3 | How many pictures are above the bed? |
| japanese_room | nume | 0.0000 | 1.0000 | -1.0000 |  | live=2 true=3 | How many calligraphy paintings are above the display ledge? |
| livingroom_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=6 true=8 | How many chairs are near the table with a vase on it? |
| livingroom_2 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=13 true=2 | How many cups are on the coffee table? |
| livingroom_3 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=8 true=2 | How many photos are on the TV cabinet? |
| livingroom_4 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=4 true=6 | How many pillows are on a sofa? |
