...
|---|---|---|---|---|---|---|---|
| arabic_room | inst | 0.5000 | 0.0000 | 0.5000 |  | legs=2/2; leg 1: threading: trajectory never crossed the gate segment | First, go to the potted plant furthest from the hookah, then take the  |
...
| chinese_room | inst | 0.0000 | 0.5000 | -0.5000 |  | legs=1/1; avoid[0]: trajectory entered capsule at (3.34, 1.27) | First, go near the tea table with the elephant figurine on it, then st |
...
| hotel_room_1 | inst | 0.3333 | 1.0000 | -0.6667 |  | legs=1/3 | First, go near the bedside table closest to the bench, then take the p |
...
| instruction_following | 10 | 9 | 1 | 0.2778 |
