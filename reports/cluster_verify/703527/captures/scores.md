...
| arabic_room | inst | 0.0000 | 0.5000 | -0.5000 |  | legs=0/0 | Go near the stool under the picture and stop at the small table farthe |
| chinese_room | inst | 0.0000 | 0.5000 | -0.5000 |  | legs=1/1; avoid[0]: trajectory entered capsule at (3.13, 0.96) | First, go near the tea table with the elephant figurine on it, then st |
