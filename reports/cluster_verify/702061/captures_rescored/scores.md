...
|---|---|---|---|---|---|---|---|
| livingroom_4 | inst | 0.6667 | 1.0000 | -0.3333 |  | legs=2/3 | First, go near the fireplace, then go to the window closest to the boo |
| livingroom_4 | inst | 1.0000 | 1.0000 | 0.0000 |  | legs=1/1 | Go near the chair closest to the bookcase and stop at the table with t |
| loft | inst | 0.6667 | 1.0000 | -0.3333 | perception built zero instances (9 keyframes processed) — capture-completeness failure (#158) | legs=2/3 | Go near the fireplace, pass by the stairs, then stop at the sphere dec |
| loft | inst | 0.0000 | 0.0000 | 0.0000 | keyframes_processed=41 is far below the job's median (144) — capture-completeness issue (#158) | legs=0/1 | Go to the cup near the TV remote and avoid the path near the cabinet. |
