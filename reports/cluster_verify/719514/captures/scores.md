...
| japanese_room | inst | 1.0000 | 1.0000 | 0.0000 | keyframes_processed=47 is far below the job's median (119) — capture-completeness issue (#158) | legs=3/3 | Go to the lantern closest to the fan decoration, then take the path ne |
...
| livingroom_2 | inst | 0.5000 | 0.5000 | 0.0000 |  | legs=1/2 | First, go to the chair near the window, then stop at the soccer ball n |
...
| instruction_following | 10 | 10 | 0 | 0.6500 |
