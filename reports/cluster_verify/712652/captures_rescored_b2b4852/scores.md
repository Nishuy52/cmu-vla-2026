...
|---|---|---|---|---|---|---|---|
| arabic_room | nume | 1.0000 | 1.0000 | 0.0000 | keyframes_processed=41 is far below the job's median (84) — capture-completeness issue (#158) | live=2 true=2 | How many sofas are below a window? |
| chinese_room | nume | 0.0000 | 1.0000 | -1.0000 |  | live=33 true=6 | Count the number of chairs with pillows on them. |
...
| hotel_room_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=3 true=4 | How many pillows are on the bed? |
| hotel_room_2 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=19 true=3 | How many pictures are above the bed? |
| japanese_room | nume | 0.0000 | 1.0000 | -1.0000 |  | live=2 true=3 | How many calligraphy paintings are above the display ledge? |
| livingroom_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=27 true=8 | How many chairs are near the table with a vase on it? |
...
| livingroom_4 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=10 true=6 | How many pillows are on a sofa? |
| loft | nume | 1.0000 | 1.0000 | 0.0000 | perception built zero instances (None keyframes processed) — capture-completeness failure (#158) | live=2 true=2 | How many black pillows are on the sofa? |
| office_1 | nume | 0.0000 | 1.0000 | -1.0000 | keyframes_processed=41 is far below the job's median (84) — capture-completeness issue (#158) | live=1 true=6 | How many computer monitors are on the table closest to the map wall de |
| office_2 | nume | 1.0000 | 1.0000 | 0.0000 |  | live=1 true=1 | How many potted plants are on a table? |
| studio | nume | 0.0000 | 1.0000 | -1.0000 |  | live=2 true=3 | How many framed records are above the couch? |

Runs with a capture-completeness issue: 3/15.
