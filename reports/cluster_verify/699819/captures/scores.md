...
| chinese_room | nume | 0.0000 | 1.0000 | -1.0000 |  | live=20 true=6 | Count the number of chairs with pillows on them. |
| home_building_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=0 true=6 | How many pillows are on the sofa under the pictures? |
| home_building_2 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=0 true=2 | How many red pillows are on the sofa? |
| hotel_room_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=22 true=4 | How many pillows are on the bed? |
...
| livingroom_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=18 true=8 | How many chairs are near the table with a vase on it? |
| livingroom_2 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=7 true=2 | How many cups are on the coffee table? |
| livingroom_3 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=6 true=2 | How many photos are on the TV cabinet? |
...
| office_1 | nume | 0.0000 | 1.0000 | -1.0000 |  | live=3 true=6 | How many computer monitors are on the table closest to the map wall de |
