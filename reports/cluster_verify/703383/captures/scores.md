...
|---|---|---|---|---|---|---|---|
| arabic_room | inst | 0.0000 | 0.0000 | 0.0000 |  | legs=1/2; leg 1: threading: trajectory never crossed the gate segment | First, go to the potted plant furthest from the hookah, then take the  |
| arabic_room | inst | 0.0000 | 0.5000 | -0.5000 | keyframes_processed=66 is far below the job's median (167) — capture-completeness issue (#158) | legs=0/0 | Go near the stool under the picture and stop at the small table farthe |
| chinese_room | inst | 0.0000 | 0.5000 | -0.5000 |  | legs=1/1; avoid[0]: trajectory entered capsule at (3.23, 1.13) | First, go near the tea table with the elephant figurine on it, then st |
...
| home_building_2 | inst | 0.5000 | 1.0000 | -0.5000 | perception built zero instances (None keyframes processed) — capture-completeness failure (#158) | legs=1/2 | Go near the magazine on the ottoman, then go to the potted plant on th |
