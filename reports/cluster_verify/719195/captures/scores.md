...
|---|---|---|---|---|---|---|---|
| hotel_room_2 | inst | 0.0000 | 1.0000 | -1.0000 |  | legs=1/3; leg 1: threading: trajectory never crossed the gate segment | First, go to the picture closest to the door, then take the path betwe |
...
| japanese_room | inst | 0.6667 | 1.0000 | -0.3333 |  | legs=2/3 | Go to the lantern closest to the fan decoration, then take the path ne |
...
| livingroom_2 | inst | 0.5000 | 0.5000 | 0.0000 | keyframes_processed=66 is far below the job's median (138) — capture-completeness issue (#158) | legs=2/2; avoid[0]: trajectory entered capsule at (1.24, -3.27) | First, go to the chair near the window, then stop at the soccer ball n |
...
| livingroom_3 | inst | 0.0000 | 0.5000 | -0.5000 |  | legs=0/1 | Take the path near the TV and go to the pillow farthest from the lamp. |
...
| instruction_following | 10 | 10 | 0 | 0.5167 |
