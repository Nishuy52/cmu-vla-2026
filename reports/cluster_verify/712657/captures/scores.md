...
| japanese_room | inst | 1.0000 | 1.0000 | 0.0000 | keyframes_processed=68 is far below the job's median (154) — capture-completeness issue (#158) | legs=3/3 | Go to the lantern closest to the fan decoration, then take the path ne |
| livingroom_1 | inst | 0.5000 | 0.0000 | 0.5000 |  | legs=1/2; leg 1: gate degenerate (anchors' footprints overlap, width=0.013m < 0.80m) — threading unevaluable, not scored | First, go near the lamp closest to the black chair, then take the path |
| livingroom_1 | inst | 1.0000 | 1.0000 | 0.0000 |  | legs=1/1 | Go to the potted plant closest to the pyramid candle holder and stop a |
| livingroom_2 | inst | 0.0000 | 0.5000 | -0.5000 |  | legs=1/2; avoid[0]: trajectory entered capsule at (1.15, -3.43) | First, go to the chair near the window, then stop at the soccer ball n |
| livingroom_2 | inst | 0.0000 | 1.0000 | -1.0000 |  | legs=0/1 | Go to the microwave on the kitchen counter and then go to the crystal  |
...
| instruction_following | 10 | 10 | 0 | 0.6167 |
