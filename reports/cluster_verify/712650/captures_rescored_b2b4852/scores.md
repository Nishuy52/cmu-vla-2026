...
|---|---|---|---|---|---|---|---|
| arabic_room | obje | 0.1519 | n/a | n/a |  |  | Find the pillow closest to the book on the stool. |
| arabic_room | obje | n/a | n/a | n/a | keyframes_processed=43 is far below the job's median (88) — capture-completeness issue (#158) | no GT target matched; IoU undefined (flagged, not guessed) | Find the wall lamp that is between a door frame and a window. |
| chinese_room | obje | 0.0000 | n/a | n/a |  |  | Find the bowl on the table closest to the folding screen. |
| chinese_room | obje | 0.2457 | n/a | n/a |  |  | Find the pillow on the chair that is closest to the TV. |
...
|---|---|---|---|---|
| numerical | 0 | 0 | 0 | n/a |
| object_reference | 16 | 12 | 0 | 0.0331 |
