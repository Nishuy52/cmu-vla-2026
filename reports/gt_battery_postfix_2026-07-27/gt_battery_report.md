# GT battery — REAL accuracy report (2026-07-27)
...
- **Numerical** (n=15): TRUE accuracy 15/15 (answer key: questions.pdf); independent (referential) agreement 50% over 10 with strict evidence; scene-graph agreement 55% over 11; 3 question(s) had no independent evidence (class-only counts excluded from agreement).
- **Object reference** (n=30): instance-match 12/12 scored (scoreability 12/30); IoU pending real perception. Match method: geometric=1, none=18, relation=10, unique=1.
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.744 (mean ordered-leg credit 0.789; 4 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 2.560 m, coverage-1m 78% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| arabic_room | obje | IoU=1.000 tgt=73(referential/relation) | target matched via relation | Find the pillow closest to the book on the stool. |
...
| arabic_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=17 | diag: Frechet=3.30m cover1m=48% |  | Go near the stool under the picture and stop at the ... |
| arabic_room | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=17 | diag: Frechet=3.46m cover1m=40% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the potted plant furthest from the hook... |
...
| chinese_room | obje | IoU=1.000 tgt=72(referential/relation) | target matched via relation | Find the pillow on the chair that is closest to the TV. |
| chinese_room | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=75 | diag: Frechet=0.88m cover1m=100% |  | Go near the potted plant on the table and stop at th... |
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=25 | diag: Frechet=4.27m cover1m=64% |  | First, go near the tea table with the elephant figur... |
| home_building_1 | nume | count=6 pipeline_gt=6, indep=14(referential), sg=11(scene_graph), ann_cov=18/18 | pipeline=6; independent=14; scene_graph=11 (disagreement) | How many pillows are on the sofa under the pictures? |
| home_building_1 | obje | IoU=1.000 tgt=185(referential/relation) | target matched via relation | Find the clock on the TV cabinet. |
| home_building_1 | obje | IoU=1.000 tgt=96(referential/relation) | target matched via relation | Find the bowl closest to the knife rack near the tra... |
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=165 | diag: Frechet=12.91m cover1m=8% | interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
| home_building_1 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=35 | diag: Frechet=12.73m cover1m=14% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment; interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the nightstand with a clock on it, then... |
...
| home_building_2 | obje | IoU=1.000 tgt=46(referential/relation) | target matched via relation | Find the lamp on the nightstand that has the photo o... |
| home_building_2 | obje | IoU=n/a tgt=None(ambiguous/none) | no GT target matched; IoU undefined (flagged, not guessed) | Find the speaker on the TV cabinet closest to the po... |
| home_building_2 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=68 | diag: Frechet=1.11m cover1m=98% |  | Go near the magazine on the ottoman, then go to the ... |
| home_building_2 | inst | rubric=0.67 legs=3/3 thread_viol=1 avoid_viol=0 poses=148 | diag: Frechet=0.74m cover1m=100% | 1 corridor leg(s) never threaded; leg 0: threading: trajectory never crossed the gate segment | Take the path between the sofa and the coffee table ... |
...
| hotel_room_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=44 | diag: Frechet=0.52m cover1m=100% |  | Go to the bedside table closest to the window and st... |
| hotel_room_1 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=40 | diag: Frechet=0.83m cover1m=100% |  | First, go near the bedside table closest to the benc... |
...
| hotel_room_2 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=23 | diag: Frechet=2.05m cover1m=100% | interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | Go between the bench and the bed and stop at the lam... |
| hotel_room_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=39 | diag: Frechet=1.45m cover1m=89% | interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the picture closest to the door, then t... |
...
| japanese_room | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=22 | diag: Frechet=0.54m cover1m=100% |  | Go near the small table with a vase on it and then t... |
| japanese_room | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=38 | diag: Frechet=1.21m cover1m=93% |  | Go to the lantern closest to the fan decoration, the... |
| livingroom_1 | nume | count=8 pipeline_gt=8, indep=9(referential), sg=9(scene_graph), ann_cov=9/9 | pipeline=8; independent=9; scene_graph=9 (disagreement) | How many chairs are near the table with a vase on it? |
...
| livingroom_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=88 | diag: Frechet=4.93m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
| livingroom_1 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=46 | diag: Frechet=1.58m cover1m=88% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment; interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go near the lamp closest to the black chair, ... |
...
| livingroom_2 | obje | IoU=n/a tgt=None(ambiguous/none) | no GT target matched; IoU undefined (flagged, not guessed) | Find the stool closest to the shelf near the TV cabi... |
...
| livingroom_2 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=45 | diag: Frechet=0.98m cover1m=100% |  | Go to the microwave on the kitchen counter and then ... |
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=46 | diag: Frechet=3.69m cover1m=74% |  | First, go to the chair near the window, then stop at... |
...
| livingroom_4 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=32 | diag: Frechet=0.95m cover1m=100% |  | Go near the chair closest to the bookcase and stop a... |
| livingroom_4 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=48 | diag: Frechet=0.35m cover1m=100% |  | First, go near the fireplace, then go to the window ... |
...
| loft | inst | rubric=0.00 legs=0/1 thread_viol=0 avoid_viol=0 poses=47 | diag: Frechet=3.55m cover1m=38% |  | Go to the cup near the TV remote and avoid the path ... |
| loft | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=57 | diag: Frechet=1.48m cover1m=100% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_1 | obje | IoU=1.000 tgt=55(geometry/geometric) | target matched via geometric | Find the potted plant on the file cabinet. |
| office_1 | obje | IoU=1.000 tgt=84(referential/relation) | target matched via relation | Find the paper cup on the table closest to the proje... |
| office_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=71 | diag: Frechet=0.62m cover1m=100% |  | Go to the potted plant furthest from the projector s... |
| office_1 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=27 | diag: Frechet=0.41m cover1m=100% |  | First, go near the potted plant on the shelf, then t... |
...
| office_2 | obje | IoU=n/a tgt=None(ambiguous/none) | no GT target matched; IoU undefined (flagged, not guessed) | Find the computer monitor closest to the cabinet wit... |
...
| office_2 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=51 | diag: Frechet=1.79m cover1m=99% |  | Go near the potted plant on the cabinet and stop at ... |
| office_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=71 | diag: Frechet=1.17m cover1m=98% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=32 | diag: Frechet=1.70m cover1m=82% |  | Go to the vases on the cabinet below the TV and stop... |
| studio | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=38 | diag: Frechet=2.46m cover1m=31% |  | First, go to the vase closest to the easel, then, ta... |
