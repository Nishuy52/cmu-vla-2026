...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.483 (mean ordered-leg credit 0.544; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 3.945 m, coverage-1m 53% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| chinese_room | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=27 | diag: Frechet=4.27m cover1m=64% |  | First, go near the tea table with the elephant figur... |
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=160 | diag: Frechet=12.41m cover1m=8% | interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
...
| hotel_room_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=9 | diag: Frechet=3.17m cover1m=39% |  | Go to the bedside table closest to the window and st... |
| hotel_room_1 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=16 | diag: Frechet=1.90m cover1m=73% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the bedside table closest to the benc... |
...
| hotel_room_2 | inst | rubric=0.50 legs=2/2 thread_viol=1 avoid_viol=0 poses=6 | diag: Frechet=0.61m cover1m=100% | 1 corridor leg(s) never threaded; leg 0: threading: trajectory never crossed the gate segment; interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | Go between the bench and the bed and stop at the lam... |
| hotel_room_2 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=37 | diag: Frechet=2.02m cover1m=78% | interior walls unavailable (frame fit residual 0.97 m > 0.8 m wall-derivation gate); boundary-only costmap | First, go to the picture closest to the door, then t... |
...
| japanese_room | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=19 | diag: Frechet=0.88m cover1m=100% |  | Go near the small table with a vase on it and then t... |
| japanese_room | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=32 | diag: Frechet=1.18m cover1m=93% |  | Go to the lantern closest to the fan decoration, the... |
...
| livingroom_1 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=118 | diag: Frechet=4.76m cover1m=12% | interior walls unavailable (frame fit residual 0.93 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the potted plant closest to the pyramid candle... |
...
| livingroom_2 | inst | rubric=1.00 legs=2/2 thread_viol=0 avoid_viol=0 poses=43 | diag: Frechet=1.11m cover1m=96% |  | Go to the microwave on the kitchen counter and then ... |
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=31 | diag: Frechet=4.79m cover1m=42% |  | First, go to the chair near the window, then stop at... |
...
| livingroom_4 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=18 | diag: Frechet=1.51m cover1m=80% |  | Go near the chair closest to the bookcase and stop a... |
...
| loft | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=6 | diag: Frechet=7.26m cover1m=32% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=29 | diag: Frechet=4.87m cover1m=48% |  | Go to the potted plant furthest from the projector s... |
| office_1 | inst | rubric=1.00 legs=3/3 thread_viol=0 avoid_viol=0 poses=18 | diag: Frechet=0.78m cover1m=100% |  | First, go near the potted plant on the shelf, then t... |
...
| office_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=52 | diag: Frechet=1.72m cover1m=98% |  | Go near the potted plant on the cabinet and stop at ... |
| office_2 | inst | rubric=0.67 legs=2/3 thread_viol=0 avoid_viol=0 poses=57 | diag: Frechet=2.55m cover1m=81% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=7 | diag: Frechet=3.47m cover1m=15% |  | Go to the vases on the cabinet below the TV and stop... |
| studio | inst | rubric=0.33 legs=2/3 thread_viol=1 avoid_viol=0 poses=17 | diag: Frechet=3.65m cover1m=12% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the vase closest to the easel, then, ta... |
