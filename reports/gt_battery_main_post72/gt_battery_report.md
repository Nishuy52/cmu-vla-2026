...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.461 (mean ordered-leg credit 0.522; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.175 m, coverage-1m 50% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=147 | diag: Frechet=12.36m cover1m=8% | interior walls unavailable (frame fit residual 0.88 m > 0.8 m wall-derivation gate); boundary-only costmap | Go to the coffee table with the kettle on it and sto... |
