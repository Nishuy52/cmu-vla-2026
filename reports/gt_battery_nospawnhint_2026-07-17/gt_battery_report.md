...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.189 (mean ordered-leg credit 0.222; 7 threading + 1 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 5.343 m, coverage-1m 27% over 24 aligned; 3 scene(s) unaligned: chinese_room, home_building_2, livingroom_3.
...
| arabic_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=46 | diag: Frechet=6.48m cover1m=0% |  | Go near the stool under the picture and stop at the ... |
| arabic_room | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=9 | diag: Frechet=7.42m cover1m=0% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the potted plant furthest from the hook... |
...
| chinese_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=9 | diag: Frechet=7.17m cover1m=13% |  | Go near the potted plant on the table and stop at th... |
| chinese_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=4 | diag: Frechet=6.18m cover1m=8% |  | First, go near the tea table with the elephant figur... |
...
| home_building_1 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=84 | diag: Frechet=16.23m cover1m=0% |  | Go to the coffee table with the kettle on it and sto... |
| home_building_1 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=238 | diag: Frechet=16.22m cover1m=0% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the nightstand with a clock on it, then... |
...
| home_building_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=61 | diag: Frechet=12.04m cover1m=19% |  | Go near the magazine on the ottoman, then go to the ... |
| home_building_2 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=261 | diag: Frechet=20.40m cover1m=21% | 1 corridor leg(s) never threaded; leg 0: threading: trajectory never crossed the gate segment | Take the path between the sofa and the coffee table ... |
...
| hotel_room_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=59 | diag: Frechet=1.23m cover1m=93% |  | Go to the bedside table closest to the window and st... |
| hotel_room_1 | inst | rubric=0.00 legs=0/3 thread_viol=0 avoid_viol=0 poses=56 | diag: Frechet=1.86m cover1m=67% |  | First, go near the bedside table closest to the benc... |
...
| hotel_room_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=5 | diag: Frechet=2.37m cover1m=95% |  | Go between the bench and the bed and stop at the lam... |
| hotel_room_2 | inst | rubric=0.33 legs=2/3 thread_viol=1 avoid_viol=0 poses=19 | diag: Frechet=4.23m cover1m=30% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the picture closest to the door, then t... |
...
| japanese_room | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=113 | diag: Frechet=5.65m cover1m=0% |  | Go near the small table with a vase on it and then t... |
| japanese_room | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=77 | diag: Frechet=4.59m cover1m=26% |  | Go to the lantern closest to the fan decoration, the... |
...
| livingroom_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=5 | diag: Frechet=7.70m cover1m=0% |  | Go to the potted plant closest to the pyramid candle... |
| livingroom_1 | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=3 | diag: Frechet=9.21m cover1m=0% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the lamp closest to the black chair, ... |
...
| livingroom_2 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=70 | diag: Frechet=4.13m cover1m=0% |  | Go to the microwave on the kitchen counter and then ... |
| livingroom_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=1 poses=70 | diag: Frechet=5.68m cover1m=0% | 1 avoid capsule(s) breached; avoid[0]: trajectory entered capsule at (2.83, -2.74) | First, go to the chair near the window, then stop at... |
...
| livingroom_3 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=46 | diag: Frechet=3.58m cover1m=0% |  | Take the path near the TV and go to the pillow farth... |
| livingroom_3 | inst | rubric=0.00 legs=0/3 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=3.58m cover1m=9% |  | First, go near the stool, then take the path near th... |
...
| livingroom_4 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=44 | diag: Frechet=2.11m cover1m=59% |  | Go near the chair closest to the bookcase and stop a... |
| livingroom_4 | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=4002 | diag: Frechet=2.49m cover1m=44% |  | First, go near the fireplace, then go to the window ... |
...
| loft | inst | rubric=1.00 legs=1/1 thread_viol=0 avoid_viol=0 poses=6 | diag: Frechet=4.82m cover1m=10% |  | Go to the cup near the TV remote and avoid the path ... |
| loft | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=61 | diag: Frechet=5.91m cover1m=6% |  | Go near the fireplace, pass by the stairs, then stop... |
...
| office_1 | inst | rubric=0.50 legs=1/2 thread_viol=0 avoid_viol=0 poses=48 | diag: Frechet=4.27m cover1m=33% |  | Go to the potted plant furthest from the projector s... |
| office_1 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=4002 | diag: Frechet=1.47m cover1m=71% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the potted plant on the shelf, then t... |
...
| office_2 | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=46 | diag: Frechet=2.14m cover1m=55% |  | Go near the potted plant on the cabinet and stop at ... |
| office_2 | inst | rubric=0.33 legs=1/3 thread_viol=0 avoid_viol=0 poses=48 | diag: Frechet=4.13m cover1m=37% |  | First, go to the trash can near the cabinet, then go... |
...
| studio | inst | rubric=0.00 legs=0/2 thread_viol=0 avoid_viol=0 poses=53 | diag: Frechet=3.47m cover1m=12% |  | Go to the vases on the cabinet below the TV and stop... |
| studio | inst | rubric=0.00 legs=0/3 thread_viol=1 avoid_viol=0 poses=9 | diag: Frechet=4.41m cover1m=0% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go to the vase closest to the easel, then, ta... |
