...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.150 (mean ordered-leg credit 0.161; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.173 m, coverage-1m 49% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
...
| hotel_room_1 | inst | rubric=0.00 legs=1/3 thread_viol=1 avoid_viol=0 poses=9 | diag: Frechet=2.83m cover1m=41% | 1 corridor leg(s) never threaded; leg 1: threading: trajectory never crossed the gate segment | First, go near the bedside table closest to the benc... |
