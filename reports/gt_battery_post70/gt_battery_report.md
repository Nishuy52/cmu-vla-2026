...
- **Instruction following** (n=30, scored=30): HEADLINE mean rubric-proxy score 0.378 (mean ordered-leg credit 0.439; 7 threading + 0 avoid violation(s) total). SECONDARY (diagnostic only): aligned planned-path mean Frechet 4.284 m, coverage-1m 47% over 28 aligned; 1 scene(s) unaligned: livingroom_3.
