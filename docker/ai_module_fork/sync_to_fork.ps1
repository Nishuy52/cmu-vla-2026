...
# (upstream_notes.md gotcha 12). Our code lives in THIS repo under src/ and
# docker/ai_module_fork/docker/Dockerfile. This script copies both into the fork's ai_module/
# directory in the exact shape the fork build expects:
#
