...
| CV sweep | **UNBLOCKED (was HELD)**: the IF rubric term now moves (0.061→0.100) so the ×6-weighted objective has gradient. Sequence complete: threading fix → battery (postT11) → sweep may now proceed |
